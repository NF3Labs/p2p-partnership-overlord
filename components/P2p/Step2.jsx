        ...
        <Grid mx="20vh" mt="110px" templateColumns="repeat(7, 1fr)">
          <GridItem colSpan={2}>
            ...
            >
              ...
              >
                <Box mt="20px" fontFamily={"Thunder-BoldLC"}>
          ...
          <GridItem colSpan={5}>
            <Box px="40px" pb="16px">
              ...
              <Text mt="22px" fontSize="24px" fontWeight="bold" color="whiter" fontFamily={"Thunder-BoldLC"}>
                {`Select NFTs from your chosen users wallet`}
              </Text>
              <Flex mt="12px">
                <InputGroup flex="1" mr="10px">
                  <InputLeftElement color={"whiter"} pl="1.5" pointerEvents="none">
                    <Search />
                  </InputLeftElement>
                  <Input
                    type="text"
